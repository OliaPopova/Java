...
public class task {
   public static void main(String[] args) {
      logger notebook1 = new logger("Honor", "8", "1000", "Windows", "grey");
      logger notebook2 = new logger("Huawei", "4", "4000", "Windows", "black");
      logger notebook3 = new logger("Macbook", "16", "4000", "MacOS", "grey");
      logger notebook4 = new logger("Asus", "16", "1000", "Windows", "grey");
      logger notebook5 = new logger("Huawei", "8", "1000", "Windows", "black");

      Set<logger> notebooks = new HashSet<>(List.of(notebook1, notebook2,
   ...
   public static void sort(Map<String, String> criterias, Set<logger> notebooks) {

      Set<logger> temp = new HashSet<>(notebooks);
      for (logger notebook : notebooks) {
